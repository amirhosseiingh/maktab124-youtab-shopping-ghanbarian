  ...
  return (
    <footer className="bg-[#f9fafb] mt-4">
      <div className="mx-auto max-w-screen-xl p-8">
        ...
        <div className="grid grid-cols-1 gap-8 mb-3 border-t border-gray-100 pt-2 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16">
          <div>
          ...
          <div>
            <p className="font-medium text-gray-900">شرکت</p>
            <ul className="mt-4 space-y-4 text-sm">
              <li>
                <a
                  href="#"
          ...
          <div>
            <p className="font-medium text-gray-900">لینک‌های مفید</p>
          ...
          <div>
            <p className="font-medium text-gray-900">قوانین</p>
        ...
        <div className="border-t-2 border-gray-100">
          <p className="text-xs text-gray-500 text-center mt-6">
            &copy; 2025 Youtab shopping All rights reserved
          </p>
        </div>
      </div>
    </footer>
